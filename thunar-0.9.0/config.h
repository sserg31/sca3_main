...
/* Define to 1 if you have the `statvfs1' function. */
/* #undef HAVE_STATVFS1 */
...
#define PACKAGE_STRING "Thunar 0.9.0"
...
/* Define to 1 if the FreeBSD volume manager implementation should be used */
/* #undef THUNAR_VFS_VOLUME_IMPL_FREEBSD */

/* Define to 1 if the HAL volume manager implementation should be used */
#define THUNAR_VFS_VOLUME_IMPL_HAL 1

/* Define to 1 if no volume manager implementation should be used */
/* #undef THUNAR_VFS_VOLUME_IMPL_NONE */
