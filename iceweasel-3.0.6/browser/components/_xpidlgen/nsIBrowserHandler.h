/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM nsIBrowserHandler.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIBrowserHandler : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFeatures(nsICommandLine *aCmdLine, nsACString & _retval) = 0;
...
#define NS_DECL_NSIBROWSERHANDLER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFeatures(nsICommandLine *aCmdLine, nsACString & _retval); 
...
#define NS_FORWARD_NSIBROWSERHANDLER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFeatures(nsICommandLine *aCmdLine, nsACString & _retval) { return _to GetFeatures(aCmdLine, _retval); } 
...
#define NS_FORWARD_SAFE_NSIBROWSERHANDLER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFeatures(nsICommandLine *aCmdLine, nsACString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFeatures(aCmdLine, _retval); } 
