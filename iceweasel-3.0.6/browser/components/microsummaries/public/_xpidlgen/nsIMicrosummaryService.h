...
class NS_NO_VTABLE NS_SCRIPTABLE nsIMicrosummaryGenerator : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIMicrosummaryGenerator *aOther, PRBool *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GenerateMicrosummary(nsIDOMNode *aPageContent, nsAString & _retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD CalculateUpdateInterval(nsIDOMNode *aPageContent, PRInt32 *_retval) = 0;
...
#define NS_DECL_NSIMICROSUMMARYGENERATOR \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIMicrosummaryGenerator *aOther, PRBool *_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GenerateMicrosummary(nsIDOMNode *aPageContent, nsAString & _retval); \
  NS_SCRIPTABLE NS_IMETHOD CalculateUpdateInterval(nsIDOMNode *aPageContent, PRInt32 *_retval); 
...
#define NS_FORWARD_NSIMICROSUMMARYGENERATOR(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIMicrosummaryGenerator *aOther, PRBool *_retval) { return _to Equals(aOther, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GenerateMicrosummary(nsIDOMNode *aPageContent, nsAString & _retval) { return _to GenerateMicrosummary(aPageContent, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CalculateUpdateInterval(nsIDOMNode *aPageContent, PRInt32 *_retval) { return _to CalculateUpdateInterval(aPageContent, _retval); } 
...
#define NS_FORWARD_SAFE_NSIMICROSUMMARYGENERATOR(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIMicrosummaryGenerator *aOther, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Equals(aOther, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GenerateMicrosummary(nsIDOMNode *aPageContent, nsAString & _retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GenerateMicrosummary(aPageContent, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CalculateUpdateInterval(nsIDOMNode *aPageContent, PRInt32 *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CalculateUpdateInterval(aPageContent, _retval); } 
...
/* boolean equals (in nsIMicrosummaryGenerator aOther); */
NS_IMETHODIMP nsMicrosummaryGenerator::Equals(nsIMicrosummaryGenerator *aOther, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* AString generateMicrosummary (in nsIDOMNode aPageContent); */
NS_IMETHODIMP nsMicrosummaryGenerator::GenerateMicrosummary(nsIDOMNode *aPageContent, nsAString & _retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* long calculateUpdateInterval (in nsIDOMNode aPageContent); */
NS_IMETHODIMP nsMicrosummaryGenerator::CalculateUpdateInterval(nsIDOMNode *aPageContent, PRInt32 *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIMicrosummary : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIMicrosummary *aOther, PRBool *_retval) = 0;
...
#define NS_DECL_NSIMICROSUMMARY \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIMicrosummary *aOther, PRBool *_retval); \
...
#define NS_FORWARD_NSIMICROSUMMARY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIMicrosummary *aOther, PRBool *_retval) { return _to Equals(aOther, _retval); } \
...
#define NS_FORWARD_SAFE_NSIMICROSUMMARY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIMicrosummary *aOther, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Equals(aOther, _retval); } \
...
/* boolean equals (in nsIMicrosummary aOther); */
NS_IMETHODIMP nsMicrosummary::Equals(nsIMicrosummary *aOther, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* nsISimpleEnumerator Enumerate (); */
NS_IMETHODIMP nsMicrosummarySet::Enumerate(nsISimpleEnumerator **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIMicrosummaryService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetGenerator(nsIURI *generatorURI, nsIMicrosummaryGenerator **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD InstallGenerator(nsIDOMDocument *xmlDefinition, nsIMicrosummaryGenerator **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetBookmarks(nsISimpleEnumerator **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMicrosummaries(nsIURI *pageURI, PRInt64 bookmarkID, nsIMicrosummarySet **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMicrosummary(PRInt64 bookmarkID, nsIMicrosummary **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateMicrosummary(nsIURI *pageURI, nsIURI *generatorURI, nsIMicrosummary **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD HasMicrosummary(PRInt64 bookmarkID, PRBool *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD IsMicrosummary(PRInt64 bookmarkID, nsIMicrosummary *microsummary, PRBool *_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD RefreshMicrosummary(PRInt64 bookmarkID, nsIMicrosummary **_retval) = 0;
...
#define NS_DECL_NSIMICROSUMMARYSERVICE \
  NS_SCRIPTABLE NS_IMETHOD GetGenerator(nsIURI *generatorURI, nsIMicrosummaryGenerator **_retval); \
  NS_SCRIPTABLE NS_IMETHOD AddGenerator(nsIURI *generatorURI); \
  NS_SCRIPTABLE NS_IMETHOD InstallGenerator(nsIDOMDocument *xmlDefinition, nsIMicrosummaryGenerator **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetBookmarks(nsISimpleEnumerator **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetMicrosummaries(nsIURI *pageURI, PRInt64 bookmarkID, nsIMicrosummarySet **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetMicrosummary(PRInt64 bookmarkID, nsIMicrosummary **_retval); \
  NS_SCRIPTABLE NS_IMETHOD CreateMicrosummary(nsIURI *pageURI, nsIURI *generatorURI, nsIMicrosummary **_retval); \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasMicrosummary(PRInt64 bookmarkID, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD IsMicrosummary(PRInt64 bookmarkID, nsIMicrosummary *microsummary, PRBool *_retval); \
  NS_SCRIPTABLE NS_IMETHOD RefreshMicrosummary(PRInt64 bookmarkID, nsIMicrosummary **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIMICROSUMMARYSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetGenerator(nsIURI *generatorURI, nsIMicrosummaryGenerator **_retval) { return _to GetGenerator(generatorURI, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD AddGenerator(nsIURI *generatorURI) { return _to AddGenerator(generatorURI); } \
  NS_SCRIPTABLE NS_IMETHOD InstallGenerator(nsIDOMDocument *xmlDefinition, nsIMicrosummaryGenerator **_retval) { return _to InstallGenerator(xmlDefinition, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetBookmarks(nsISimpleEnumerator **_retval) { return _to GetBookmarks(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetMicrosummaries(nsIURI *pageURI, PRInt64 bookmarkID, nsIMicrosummarySet **_retval) { return _to GetMicrosummaries(pageURI, bookmarkID, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetMicrosummary(PRInt64 bookmarkID, nsIMicrosummary **_retval) { return _to GetMicrosummary(bookmarkID, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateMicrosummary(nsIURI *pageURI, nsIURI *generatorURI, nsIMicrosummary **_retval) { return _to CreateMicrosummary(pageURI, generatorURI, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasMicrosummary(PRInt64 bookmarkID, PRBool *_retval) { return _to HasMicrosummary(bookmarkID, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsMicrosummary(PRInt64 bookmarkID, nsIMicrosummary *microsummary, PRBool *_retval) { return _to IsMicrosummary(bookmarkID, microsummary, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD RefreshMicrosummary(PRInt64 bookmarkID, nsIMicrosummary **_retval) { return _to RefreshMicrosummary(bookmarkID, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIMICROSUMMARYSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetGenerator(nsIURI *generatorURI, nsIMicrosummaryGenerator **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetGenerator(generatorURI, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD AddGenerator(nsIURI *generatorURI) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddGenerator(generatorURI); } \
  NS_SCRIPTABLE NS_IMETHOD InstallGenerator(nsIDOMDocument *xmlDefinition, nsIMicrosummaryGenerator **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->InstallGenerator(xmlDefinition, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetBookmarks(nsISimpleEnumerator **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBookmarks(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetMicrosummaries(nsIURI *pageURI, PRInt64 bookmarkID, nsIMicrosummarySet **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMicrosummaries(pageURI, bookmarkID, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetMicrosummary(PRInt64 bookmarkID, nsIMicrosummary **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMicrosummary(bookmarkID, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateMicrosummary(nsIURI *pageURI, nsIURI *generatorURI, nsIMicrosummary **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateMicrosummary(pageURI, generatorURI, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasMicrosummary(PRInt64 bookmarkID, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasMicrosummary(bookmarkID, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD IsMicrosummary(PRInt64 bookmarkID, nsIMicrosummary *microsummary, PRBool *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsMicrosummary(bookmarkID, microsummary, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD RefreshMicrosummary(PRInt64 bookmarkID, nsIMicrosummary **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->RefreshMicrosummary(bookmarkID, _retval); } 
...
/* nsIMicrosummaryGenerator getGenerator (in nsIURI generatorURI); */
NS_IMETHODIMP nsMicrosummaryService::GetGenerator(nsIURI *generatorURI, nsIMicrosummaryGenerator **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* nsIMicrosummaryGenerator installGenerator (in nsIDOMDocument xmlDefinition); */
NS_IMETHODIMP nsMicrosummaryService::InstallGenerator(nsIDOMDocument *xmlDefinition, nsIMicrosummaryGenerator **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsISimpleEnumerator getBookmarks (); */
NS_IMETHODIMP nsMicrosummaryService::GetBookmarks(nsISimpleEnumerator **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIMicrosummarySet getMicrosummaries (in nsIURI pageURI, in long long bookmarkID); */
NS_IMETHODIMP nsMicrosummaryService::GetMicrosummaries(nsIURI *pageURI, PRInt64 bookmarkID, nsIMicrosummarySet **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIMicrosummary getMicrosummary (in long long bookmarkID); */
NS_IMETHODIMP nsMicrosummaryService::GetMicrosummary(PRInt64 bookmarkID, nsIMicrosummary **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIMicrosummary createMicrosummary (in nsIURI pageURI, in nsIURI generatorURI); */
NS_IMETHODIMP nsMicrosummaryService::CreateMicrosummary(nsIURI *pageURI, nsIURI *generatorURI, nsIMicrosummary **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean hasMicrosummary (in long long bookmarkID); */
NS_IMETHODIMP nsMicrosummaryService::HasMicrosummary(PRInt64 bookmarkID, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean isMicrosummary (in long long bookmarkID, in nsIMicrosummary microsummary); */
NS_IMETHODIMP nsMicrosummaryService::IsMicrosummary(PRInt64 bookmarkID, nsIMicrosummary *microsummary, PRBool *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIMicrosummary refreshMicrosummary (in long long bookmarkID); */
NS_IMETHODIMP nsMicrosummaryService::RefreshMicrosummary(PRInt64 bookmarkID, nsIMicrosummary **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
