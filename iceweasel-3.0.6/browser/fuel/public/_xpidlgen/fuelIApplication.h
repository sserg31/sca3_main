/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM fuelIApplication.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE fuelIAnnotations : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Get(const nsAString & aName, nsIVariant **_retval) = 0;
...
#define NS_DECL_FUELIANNOTATIONS \
  ...
  NS_SCRIPTABLE NS_IMETHOD Get(const nsAString & aName, nsIVariant **_retval); \
...
#define NS_FORWARD_FUELIANNOTATIONS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Get(const nsAString & aName, nsIVariant **_retval) { return _to Get(aName, _retval); } \
...
#define NS_FORWARD_SAFE_FUELIANNOTATIONS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Get(const nsAString & aName, nsIVariant **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Get(aName, _retval); } \
...
/**
  ...
  NS_SCRIPTABLE NS_IMETHOD AddBookmark(const nsAString & aTitle, nsIURI *aURI, fuelIBookmark **_retval) = 0;

  /**
   * Adds a new child separator to this folder.
   */
  /* fuelIBookmark addSeparator (); */
  NS_SCRIPTABLE NS_IMETHOD AddSeparator(fuelIBookmark **_retval) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD AddFolder(const nsAString & aTitle, fuelIBookmarkFolder **_retval) = 0;
...
#define NS_DECL_FUELIBOOKMARKFOLDER \
  ...
  NS_SCRIPTABLE NS_IMETHOD AddBookmark(const nsAString & aTitle, nsIURI *aURI, fuelIBookmark **_retval); \
  NS_SCRIPTABLE NS_IMETHOD AddSeparator(fuelIBookmark **_retval); \
  NS_SCRIPTABLE NS_IMETHOD AddFolder(const nsAString & aTitle, fuelIBookmarkFolder **_retval); \
  NS_SCRIPTABLE NS_IMETHOD Remove(void); 
...
#define NS_FORWARD_FUELIBOOKMARKFOLDER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD AddBookmark(const nsAString & aTitle, nsIURI *aURI, fuelIBookmark **_retval) { return _to AddBookmark(aTitle, aURI, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD AddSeparator(fuelIBookmark **_retval) { return _to AddSeparator(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD AddFolder(const nsAString & aTitle, fuelIBookmarkFolder **_retval) { return _to AddFolder(aTitle, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Remove(void) { return _to Remove(); } 
...
#define NS_FORWARD_SAFE_FUELIBOOKMARKFOLDER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD AddBookmark(const nsAString & aTitle, nsIURI *aURI, fuelIBookmark **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddBookmark(aTitle, aURI, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD AddSeparator(fuelIBookmark **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddSeparator(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD AddFolder(const nsAString & aTitle, fuelIBookmarkFolder **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddFolder(aTitle, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD Remove(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->Remove(); } 
...
/* fuelIBookmark addBookmark (in AString aTitle, in nsIURI aURI); */
NS_IMETHODIMP _MYCLASS_::AddBookmark(const nsAString & aTitle, nsIURI *aURI, fuelIBookmark **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* fuelIBookmark addSeparator (); */
NS_IMETHODIMP _MYCLASS_::AddSeparator(fuelIBookmark **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* fuelIBookmarkFolder addFolder (in AString aTitle); */
NS_IMETHODIMP _MYCLASS_::AddFolder(const nsAString & aTitle, fuelIBookmarkFolder **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE NS_SCRIPTABLE fuelIWindow : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Open(nsIURI *aURI, fuelIBrowserTab **_retval) = 0;
...
#define NS_DECL_FUELIWINDOW \
  ...
  NS_SCRIPTABLE NS_IMETHOD Open(nsIURI *aURI, fuelIBrowserTab **_retval); \
  NS_SCRIPTABLE NS_IMETHOD GetEvents(extIEvents * *aEvents); 
...
#define NS_FORWARD_FUELIWINDOW(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Open(nsIURI *aURI, fuelIBrowserTab **_retval) { return _to Open(aURI, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetEvents(extIEvents * *aEvents) { return _to GetEvents(aEvents); } 
...
#define NS_FORWARD_SAFE_FUELIWINDOW(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Open(nsIURI *aURI, fuelIBrowserTab **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->Open(aURI, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetEvents(extIEvents * *aEvents) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEvents(aEvents); } 
...
/* fuelIBrowserTab open (in nsIURI aURI); */
NS_IMETHODIMP _MYCLASS_::Open(nsIURI *aURI, fuelIBrowserTab **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
